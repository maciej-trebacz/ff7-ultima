...
function Row(props: {
  ...
  return (
    <div className={"flex w-full tooltip-up my-1 first:mt-0 " + (props.onRowClick ? "tooltip" : "")} data-tip="Click to edit">
      <label className={"flex items-center w-full px-2 py-1.5 rounded-md text-xs bg-zinc-800 " + (props.onRowClick ? "hover:text-white hover:bg-zinc-700 cursor-pointer" : "")} onClick={props.onRowClick}>
